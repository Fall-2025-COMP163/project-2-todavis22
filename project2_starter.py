...
class Character:
    ...
    def display_stats(self):
        ...
        """
        print(f"Character name: {self.name} Health: {self.health} Strength: {self.strength} Magic: {self.magic}")
...
class Player(Character):
    ...
    def display_stats(self):
        ...
        print(f"Character Zeni: {self.zeni}")
...
class Weapon:
    ...
    def __init__(self, name, damage_bonus):
        ...
        """
        self.name = name
        self.damage_bonus = damage_bonus * 2
    ...
    def display_info(self):
        ...
        """
        print(f"Your weapon name is {self.name} and your weapon damage is {self.damage_bonus}")
